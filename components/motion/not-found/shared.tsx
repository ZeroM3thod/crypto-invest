  ...
  return (
    ...
    >
      <motion.a
        ...
        className="inline-flex h-11 select-none items-center justify-center rounded-full bg-success px-6 text-sm font-medium text-background transition-colors hover:bg-success/90"
      >
        {homeLabel}
      </motion.a>
      <motion.a
